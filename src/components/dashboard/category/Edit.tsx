...
function CategoryEdit({ id }: Readonly<IdParams>) {
	...
	return (
		<>
			<Link href={'/dashboard/categories'} className="p-2 bg-blue-600 text-white cursor-pointer rounded-md">
				Back
			</Link>
			<div className="mt-4 mb-2 text-xl font-bold">Edit category ID: {id}</div>
			...
			<form onSubmit={handleSubmit(onSubmit)} className="flex gap-2">
				...
				/>
				<button type="submit" className="bg-blue-500 text-white px-4 py-2 cursor-pointer rounded-md">
					Update
				</button>
